...
// They are derived and mapped from the underlying database models defined in database.types.ts
...
export type WardrobeItemDTO = Pick<WardrobeItemsRow, "id" | "category_id" | "name" | "color" | "brand" | "created_at" | "updated_at" | "user_id">;
...
export type CreationDTO = Pick<CreationsRow, "id" | "name" | "image_path" | "style_id" | "created_at" | "updated_at" | "user_id">;
...
export type CreateCreationCommand = Omit<CreationDTO, "id" | "created_at" | "updated_at" | "user_id">;
